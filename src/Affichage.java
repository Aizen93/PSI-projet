...
public class Affichage {
	...
	public static void display_error(String error) {
		System.out.println(Color.RED_BOLD_BRIGHT + error + Color.ANSI_RESET);

	}

	public static void display_command_request() {
        System.out.print(Color.BLUE_BOLD_BRIGHT + "> Enter a command: " + Color.ANSI_RESET);
	}
	
	public static void display_message_notification(int n) {
		System.out.println(Color.CYAN_BOLD_BRIGHT + "You have "+ n +" new unseen message(s)" + Color.ANSI_RESET);
	}
	
	public static void display_connected() {
        System.out.println(Color.GREEN_BOLD_BRIGHT + "############################" + Color.ANSI_RESET);
        System.out.println(Color.GREEN_BOLD_BRIGHT + "# Connection successfull ! #" + Color.ANSI_RESET);
        System.out.println(Color.GREEN_BOLD_BRIGHT + "############################" + Color.ANSI_RESET);
	}
	
	public static void display_disconnected() {
        System.out.println(Color.GREEN_BOLD_BRIGHT + "################" + Color.ANSI_RESET);
        System.out.println(Color.GREEN_BOLD_BRIGHT + "# Disconnected #" + Color.ANSI_RESET);
        System.out.println(Color.GREEN_BOLD_BRIGHT + "################" + Color.ANSI_RESET);
        System.out.println(Color.YELLOW_BOLD_BRIGHT + "Now, you can only request public annouces but can't interact with anything else !" + Color.ANSI_RESET);
	}
    ...
    public static void display_client_connect(int status, String pseudo, String mdp) {
        if(pseudo == null) {
            System.out.println(Color.YELLOW_BOLD_BRIGHT + "--------------New guest -----------------------" + Color.ANSI_RESET);
        }else{
            System.out.println(Color.YELLOW_BOLD_BRIGHT + "-------------------------------------------" + Color.ANSI_RESET);

            if(status == 0) System.out.println(Color.YELLOW_BOLD_BRIGHT + "            ----> New User created" + Color.ANSI_RESET);
            else System.out.println(Color.YELLOW_BOLD_BRIGHT + "            ----> User connected" + Color.ANSI_RESET);
